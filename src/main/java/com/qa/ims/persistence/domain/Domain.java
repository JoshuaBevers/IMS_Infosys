...
public enum Domain {
    ...
    CUSTOMER("Information about customers"), ITEM("Individual Items"), ORDER("Creates and order request"),
    PURCHASES("Adds an item to the order"), STOP("To close the application");
